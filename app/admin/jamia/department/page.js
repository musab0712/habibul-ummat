...
export default function AboutPageEditor() {
  ...
  useEffect(() => {
    const loadAboutData = async () => {
      try {
        ...
        console.error("Error loading jamia department data:", error);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (result.success) {
        setMessage("Jamia Department page saved successfully!");
        setTimeout(() => setMessage(""), 3000);
      } else {
        setMessage("Error saving jamia department page: " + result.message);
      }
    } catch (error) {
      setMessage("Error saving jamia department page");
      console.error("Error saving jamia department data:", error);
    } finally {
      setIsSaving(false);
    }
  };
        ...
        <div className="px-6 py-4">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-gray-800">
              Jamia Department Page Management
            </h1>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Jamia Department - Page Title"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
